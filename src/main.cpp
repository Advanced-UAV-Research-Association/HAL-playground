...
void loop() 
{
  ...
  Serial.print("aX = "); Serial.print (convert_int16_to_str(accel_x));//Print out acceleration data
  Serial.print(" | aY = "); Serial.print (convert_int16_to_str(accel_y));
  Serial.print(" | aZ = "); Serial.print (convert_int16_to_str(accel_z));
//First part prints out the data format. The second converts values to Raw Data
